...
\title[Simulación Orbital]{Simulación Numérica de Inyección Orbital y \\ cálculo del ángulo de panel solar del satelite}
...
\begin{frame}{Arquitectura de Software}
  ...
  \begin{itemize}
      ...
      \item \textbf{Visualización:} Frontend simple con jsx.
  \end{itemize}
